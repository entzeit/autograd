...
def binary_function(a,b,c,d,e):
    return xor(a,b) and (c or not b) or xor(d, not e)
X_train, Y_train, X_test, Y_test = DataGenerator([(binary_function)], binary=True, seed=seed).generate(size=200)

input_size = X_train[0].shape[0]
layers = [(5, Tensor.relu), (10, Tensor.relu), (1, Tensor.sigmoid)]
